// frontend/src/components/dashboard/edit-project/step-progress.tsx
import { Check, Edit, Eye, Save } from "lucide-react";

type FormStep = "form" | "review" | "submit";

const steps = [
  { key: "form", label: "Edit Details", icon: Edit, step: 1 },
  { key: "review", label: "Review", icon: Eye, step: 2 },
  { key: "submit", label: "Update", icon: Save, step: 3 },
];
