...
import { SupportingDocument } from "@/types/archive-projects.types";
import { formatFileSize } from "@/utils/archive-projects/format-helpers";
  ...
  return (
    <div className={`space-y-2 ${className}`}>
      {documents.map((doc, index) => (
        <Card key={doc._id || index} className="border border-gray-200">
