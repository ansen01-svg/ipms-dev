...
interface ArchiveProjectNotFoundProps {
  projectId?: string;
}

export function ArchiveProjectNotFound({
  projectId,
}: ArchiveProjectNotFoundProps) {
  ...
  const handleGoToArchiveProjects = () => {
      ...
      <Card className="bg-white border border-gray-100 shadow-sm rounded-lg overflow-hidden">
        ...
        <div className="bg-teal-600 px-8 py-12 text-center">
          <h1 className="text-2xl sm:text-3xl font-semibold text-white mb-2">
            Archive Project Not Found
          </h1>
          <p className="text-teal-100">
            {projectId
              ? `The archive project with ID "${projectId}" could not be found.`
              : "The requested archive project could not be found."}
          </p>
        </div>
          ...
          <div className="max-w-2xl mx-auto text-center">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm text-start text-gray-600">
                <div className="bg-gray-50 rounded-lg p-4">
                  <div className="font-medium text-gray-900 mb-2">
                    Archive project may have been:
                  </div>
                  <ul className="space-y-1 text-left">
                    <li>• Moved to another archive</li>
                    <li>• Permanently deleted</li>
                    <li>• Access restricted</li>
                    <li>• Migrated to new system</li>
                  </ul>
                </div>
                <div className="bg-gray-50 rounded-lg p-4">
                  <div className="font-medium text-gray-900 mb-2">
                  ...
                  <ul className="space-y-1 text-left">
                    ...
                    <li>• Expired archive link</li>
                    <li>• Different project ID format</li>
                  </ul>
                </div>
              </div>
            </div>
            ...
            <div className="mt-8 pt-6 border-t border-gray-100">
              <p className="text-sm text-gray-500 mb-4">
                Still having trouble accessing archive projects?{" "}
                <span className="text-teal-600 hover:text-teal-700">
                  Contact support
                </span>
              </p>
              <div className="text-xs text-gray-400">
                Archive projects contain historical data that may have different
                access patterns than active projects.
              </div>
            </div>
          </div>
        </CardContent>
