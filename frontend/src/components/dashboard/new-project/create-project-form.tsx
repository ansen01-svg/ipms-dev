...
//           <InfoItem
//             label="Sanction & Department"
//             value={formData.sanctionAndDepartment}
//           />
//         </CardContent>
//       </Card>
...
//         fund: values.fund,
//         sanctionAndDepartment: values.sanctionAndDepartment,
...
//       console.log("Submitting payload to API:", apiPayload);
...
//         } catch {
//           // If response isn't JSON, use the raw text or default message
...
//         throw new Error(
//           apiResult.message || "Project creation failed on server"
//         );
//       }

//       console.log("API call successful:", apiResult);

//       // Generate project data for PDF - only on success
//       const projectData: ProjectPDFData = {
//         ...values,
//         projectId: apiResult?.data?.projectId || `PROJ_${Date.now()}`,
...
//                               </FormControl>
//                               <SelectContent>
//                                 {dropdownOptions.natureOfWork.map((nature) => (
...
//                       </CardTitle>
//                       <CardDescription>
//                         Specify the project location and geographical details
//                       </CardDescription>
//                     </CardHeader>
//                     <CardContent className="space-y-4 sm:space-y-6">
//                       <FormField
                            ...
                            render={({ field }) => (
                              <FormItem>
                                ...
                                >
                                  ...
                                  <SelectContent>
                                    {dropdownOptions?.natureOfWork.map(
                                      (nature) => (
                                        <SelectItem key={nature} value={nature}>
                                          {nature}
                                        </SelectItem>
                    ...
                    <Card>
                      ...
                      <CardContent className="space-y-6">
                        ...
                        <div className="text-center py-8">
                          ...
                          <p className="text-gray-600 mb-6">
                            Click the button below to create your project and
