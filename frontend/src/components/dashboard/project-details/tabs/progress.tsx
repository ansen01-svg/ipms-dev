...
import { BarChart3, FileText, IndianRupeeIcon, TrendingUp } from "lucide-react";
...
export default function ProgressTab({ project }: ProgressTabProps) {
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-2">
          <Badge className="bg-green-50 text-green-600 border-green-200 text-xs">
            {project.progressPercentage || 0}% Physical
          </Badge>
          <Badge className="bg-blue-50 text-blue-600 border-blue-200 text-xs">
            {project.financialProgress.toFixed(1) || 0}% Financial
          </Badge>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-3">
                    ...
                    <div className="w-full bg-gray-200 rounded-full h-4">
                      ...
                      >
                        {(project.progressPercentage || 0) > 10 && (
          ...
          <Card>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="text-center">
                  <div className="text-2xl font-bold text-purple-600 mb-2">
                    {100 - (project.progressPercentage || 0)}%
                  </div>
                  <div className="text-sm text-gray-500 mb-3">
                    Remaining Work
                  </div>
