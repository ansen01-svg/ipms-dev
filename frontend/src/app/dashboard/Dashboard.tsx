...
import ProjectsLineChart from "@/components/ProjectsLineChart"
import AssamDistrictMap from "@/components/AssamDistrictMap"
      ...
      <div className="p-6 grid grid-cols-1 lg:grid-cols-[2fr_1fr] gap-6">
        ...
        <div className="bg-white rounded-lg shadow overflow-x-auto">
          ...
          <div className="bg-white rounded-lg shadow p-4">
            <h5 className="font-semibold mb-2 text-center">Chart: Active Users per Role</h5>
        ...
        <div className="bg-white rounded-lg shadow overflow-x-auto">
          ...
          <div className="bg-white rounded-lg shadow p-4">
            <h5 className="font-semibold mb-2 text-center">Chart: Task Status Summary</h5>
        ...
        <div className="bg-white rounded-lg shadow overflow-x-auto">
              ...
              {projectData.map((project) => (
                <tr key={project.id} className="hover:bg-gray-50 border">
                  ...
                  <td className="px-4 py-2 border">
                    <Badge
                      className={`px-3 py-1 text-sm rounded ${project.status === "Active"
          ...
          <div className="bg-white rounded-lg shadow p-4">
            <h5 className="font-semibold mb-2 text-center">Line Chart: Projects Created</h5>
